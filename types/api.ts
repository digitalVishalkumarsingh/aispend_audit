...
export type CreateAuditResponse = ApiResponse<AuditResult>;

// GET /api/audit?id=...
export type GetAuditResponse = ApiResponse<AuditResult>;

// POST /api/generate-summary
export type GenerateSummaryRequest = {
    auditId: string;
};
export type GenerateSummaryResponse = ApiResponse<{
    summary: string;
...
export type SaveLeadResponse = ApiResponse<Lead>;
